...
public:
    ...
    inline Vec2 GetGlobalPosition() const { return Vec2(m_GlobalMatrix.mat[0][2], m_GlobalMatrix.mat[1][2]); }
    inline Vec3 GetGlobalPosition3() const { return Vec3(m_GlobalMatrix.mat[0][2], m_GlobalMatrix.mat[1][2], m_GlobalMatrix.mat[2][2]); }
