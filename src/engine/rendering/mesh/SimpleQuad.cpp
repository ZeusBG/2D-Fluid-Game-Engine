...
void SimpleQuad::InitializeBuffers(VisualComponent* visualComponent)
{
	...
	vertexBufferDesc.ByteWidth = sizeof(SimpleVertex) * m_Vertices.size();
...
void SimpleQuad::BindData() const
{
	unsigned int stride;
	unsigned int offset;
...
void SimpleQuad::DeSerializeFromJSON(const rapidjson::Value& val)
{
}
